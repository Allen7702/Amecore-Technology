        ...
        <div class="row py-5">
            ...
            <div class="col-lg-5">
                <div class="row px-3">
                    ...
                    <div class="col-6 p-0">
                        <img class="img-fluid w-100" src="img/tele.jpg" alt="">
                    </div>
                    <div class="col-6 p-0">
                        <img class="img-fluid w-100" src="img/cybe.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
